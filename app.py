...
if "user_id" in st.session_state:
    ...
    if option == "Generate Notes":
        ...
        if st.button("Get Answer"):
            answer = generate_content(f"Answer this doubt based on Cloud computing: {question}, answer the doubt to the best of your knowledge do not ask for more context. If the asked doubt is not related to cloud computing output- I can only answer questions related to cloud, dew, edge, fog computing. Reply as a specialized chatbot for teaching subjects related to cloud computing")
            st.write(answer)
